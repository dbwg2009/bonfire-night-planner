...
export function Switch({ className, ...props }: SwitchProps) {
  return (
    <SwitchPrimitive.Root
      className={cn(
        'peer inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-fire-400/50 disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-fire-500 data-[state=unchecked]:bg-smoke-700',
        className
      )}
      {...props}
    >
